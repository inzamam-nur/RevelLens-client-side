  ...
  return (
    <div className="navbar bg-gray-100 rounded pt-5 pb-5	">
      <div className="navbar-start">
        ...
        <Link to="/" className=" normal-case text-xl font-bold italic">
          <span>R</span>
          <span style={{ color: "rgb(204,73,79)" }}>e</span>
          <span style={{ color: "rgb(207,35,143)" }}>v</span>
          <span style={{ color: "rgb(4,186,200)" }}>e</span>
          <span style={{ color: "rgb(120,189,65)" }}>l</span>L
          <span style={{ color: "rgb(241,89,40)" }}>e</span>
          <span style={{ color: "rgb(207,35,143)" }}>n</span>s
        </Link>
      </div>
